...
# img_dir = data_root + r"\images_flip_256"
# ann_dir = data_root + r"\labels_flip_256"
# img_suffix = f".tif"
# seg_map_suffix = f".tif"
#
splits = {
    "train": "data_splits/train_data.txt",
    "val": "data_splits/val_data.txt",
    "test": "data_splits/train_split.txt",
}
# img_dir = data_root+ os.sep +"Images"
# ann_dir = data_root + os.sep +"Labels"
# img_suffix = f"_S2L1C.tif"
# seg_map_suffix = f"_ReferenceMask_manual.tif"

# splits = {
#     "train": "data_splits/CloudSEN12_train_sample.txt",
#     "val": "data_splits/CloudSEN12_test_sample.txt",
#     "test": "data_splits/CloudSEN12_test_sample.txt",
# }
...
pretrained_weights_path = r"E:\_Flood_Inundation_Mapping\Code\hls-foundation-os-main\FloodMapping\HLSSegmentResume-450\work_dirs\epoch_320.pth"
num_layers = 12
patch_size = 16
embed_dim = 768
num_heads = 12
...
experiment = "HLSSegment-rsm320-300-27-flip-900"
project_dir = "FloodContest"
...
# optimizer = dict(type="Adam", lr=6e-5, weight_decay=0.1)
